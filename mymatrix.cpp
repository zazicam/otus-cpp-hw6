...
template<typename T, T d>
TCell<T,d>::operator T(void) const{
	return GetValue();
}
//------------------------------------------------------------------------------
...
template<typename T, T d>
OwnContainer<T,d>::OwnContainer(void){
}
...
template<typename T, T d>
size_t OwnContainer<T,d>::size(void) const{
	return _m.size();
}

template<typename T, T d>
OwnIterator<T,d> OwnContainer<T,d>::begin(void){
		return iterator(_m.begin());
}

template<typename T, T d>
OwnIterator<T,d> OwnContainer<T,d>::end(void){
...
template<typename T, T d>
std::tuple<int,int,T> OwnIterator<T,d>::operator*(void) const{
...
template<typename T, T d>
OwnIterator<T,d>& OwnIterator<T,d>::operator++(void){
	it++;
	return *this;
}
//------------------------------------------------------------------------------
